...
void HTMLDialogElement::close_the_dialog(Optional<String> result)
{
    ...
    if (m_previously_focused_element) {
        ...
        // Spec bug: https://github.com/whatwg/html/pull/10994
        // The spec incorrectly states "is shadow-including inclusive descendant of element".
        // It should be "is shadow-including inclusive descendant of subject", so we implement it that way.
