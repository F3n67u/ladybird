...
using ClipboardItemData = GC::Root<WebIDL::Promise>;
...
public:
    struct Representation {
        ...
        ClipboardItemData data; // The actual data for this representation.
    };

    static WebIDL::ExceptionOr<GC::Ref<ClipboardItem>> construct_impl(JS::Realm&, OrderedHashMap<String, ClipboardItemData> const& items, ClipboardItemOptions const& options = {});
